...
public class Provider extends ContentProvider {
   ...
   /* @NonNull
    ...
    private Cursor getStickerPackInfo(@NonNull Uri uri, boolean all,@NonNull List<StickerPack> stickerPackList) {
        String AndroidPlayStore_Link = "https://play.google.com/store/apps/details?id=com.mundoapp.emojieditor";
        String IosAppStore_Link = "https://itunes.apple.com/us/app/the-best-love-images/id1507742157";
        stickertype = FileUtil.get_selectedSticker(getContext());
      ...
      //  }
        for (StickerPack stickerPack : stickerPackList){
            ...
            builder.add("Emoji stickers");
            builder.add("Emoji mix maker");
    ...
    /*    if(all)
            for (int i=1;i<=1+(GlobalVariable.stickersWhassap.size()/30);i++) {
                ...
                builder.add("EmojiSet stickers "+i);
                builder.add("EmojiSet Mundoapp ");
                builder.add("sticker.webp");
                builder.add(AndroidPlayStore_Link);
                builder.add(IosAppStore_Link);
                builder.add("");

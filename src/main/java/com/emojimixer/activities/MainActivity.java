...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Admob.miPublicidad.baner( (FrameLayout) findViewById(R.id.ad_view_container), this);
    ...
    public void initLogic() {
        ...
        saveEmoji.setOnClickListener(view -> {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                ...
                File file = FileUtil.saveEmojiBIG(yo, this.layoutEmojiCreation, yo.getFilesDir() + "/stickers/");
    ...
    private void LOGIC_BACKEND() {
        ...
        if (sharedPref.getString("supportedEmojisList", "").isEmpty()) {
            requestSupportedEmojis.startRequestNetwork(RequestNetworkController.GET, "https://emojimix.queautoescuela.com/emojis/supported_emojis.json", "", requestSupportedEmojisListener);
        } else {

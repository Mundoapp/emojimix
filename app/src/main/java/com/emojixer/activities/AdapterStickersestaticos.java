...
public class AdapterStickersestaticos extends RecyclerView.Adapter<AdapterStickersestaticos.MViewHolder>
{
    ...
    public AdapterStickersestaticos(@NonNull final LayoutInflater layoutInflater, Activity context, String filename) {
    ...
    private class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            view.findViewById(R.id.compartir).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(new File(uri.getPath()).getName().contains("SImage")) {
                        Bitmap transBmp = Bitmap.createBitmap(1048, 1048, Bitmap.Config.ARGB_8888);
                        transBmp.eraseColor(Color.WHITE);
                        Bitmap bitmap = BitmapFactory.decodeFile(uri.getPath());
                        transBmp = GlobalClass.mergeToPin(transBmp, bitmap, mContext);
                        if (transBmp != null)

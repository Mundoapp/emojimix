...
import static com.emojitwomix.functions.UIMethods.shadAnimestaticos;
...
import com.emojitwomix.adapters.Adapterestaticos;
import com.emojitwomix.functions.ZoomLayoutManager;
import com.emojitwomix.functions.EmojiMixerestaticos;
...
//            int minutes = (int) (diff / (1000 * 60));
            ...
            String toastText = getString(R.string.guardar);
    ...
    public boolean esPrimeraVez() {
        ...
        boolean esPrimeraVez = prefs.getBoolean("esPrimera", true);

        if (esPrimeraVez) {
            SharedPreferences.Editor editor = prefs.edit();
            editor.putBoolean("esPrimera", false);
            editor.apply();
        }

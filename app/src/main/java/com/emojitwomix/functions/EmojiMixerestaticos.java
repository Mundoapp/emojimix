...
public class EmojiMixerestaticos implements Runnable {
    ...
    public EmojiMixerestaticos(String emoji1, String emoji2, String idemote2, String idemote1, String date, Activity context, EmojiListener emojiListener) {

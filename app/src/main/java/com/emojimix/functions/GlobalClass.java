...
import com.emojimix.activities.BitmapTransform;
...
public class GlobalClass {
    ...
    public static void download(final Activity context, Bitmap bitmap) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                File dir = new File(context.getFilesDir() + "/fileaux");
                ...
                values.put(MediaStore.MediaColumns.DATA, imageUri.getPath());

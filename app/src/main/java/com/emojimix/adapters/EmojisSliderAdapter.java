...
public class EmojisSliderAdapter extends RecyclerView.Adapter<EmojisSliderAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        String emojiURL = "http://emojixer.emojinew.com/panel/images_formas/";
        String emojiURL2 = "http://emojixer.emojinew.com/panel/emoji_formado/";

...
public class MainActivity extends AppCompatActivity {
    ...
    private LottieAnimationView emojitop;
    ...
    public static String api_emojis ="https://emojixer.emojinew.com/panel/api.php?todos=1";
    public static String APITOP ="https://emojixer.emojinew.com/panel/apitop.php?";
...
//            int minutes = (int) (diff / (1000 * 60));
    ...
    public void numeroemojis() {
        ...
        RequestQueue queue = Volley.newRequestQueue(context);
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, "https://emojixer.emojinew.com/panel/api.php?nemojis=1",
                (String) null, new Response.Listener<JSONObject>() {
            //  @RequiresApi(api = Build.VERSION_CODES.KITKAT)
            @Override
            public void onResponse(JSONObject response) {
    ...
    private void LOGIC_BACKEND() {
        ...
        requestSupportedEmojis.startRequestNetwork(RequestNetworkController.GET, "https://emojixer.emojinew.com/panel/api.php?todos=1", "", requestSupportedEmojisListener);
